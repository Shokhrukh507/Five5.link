...
DATABASES = {
    'default': {
        ...
        'NAME': 'shokhrukh', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'techtorial1234',
        'HOST': 'database-2.clrld7gcfi02.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-shokhrukh' # please enter your s3 bucket name
